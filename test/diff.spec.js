describe('Diff', function(){
    ...
    describe('Anchor Differences', function(){
      ...
      it('should show two anchors are the same if their href attributes are the same', function() {
        var before = html_to_tokens('<a href="a.jpg" class="btn">a</a>');
        var after = html_to_tokens('<a href="a.jpg">a</a>');
        var ops = calculate_operations(before, after);
